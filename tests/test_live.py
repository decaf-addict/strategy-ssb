...
# def test_live_migration_usdc_bal(
#         chain,
#         vault,
#         amount,
#         strategy,
...
#     fromGov = {'from': gov}
#
#     strategy.whitelistRewards(bal, swapStepsBal, fromGov)
#     assert False
#     vault.migrateStrategy(old, strategy, fromGov)
#     util.stateOfStrat("old strategy after migration", old, token)
#     util.stateOfStrat("new strategy after migration", strategy, token)
#
#     total_debt = vault.strategies(fixed_strategy)["totalDebt"]
#     assert strategy.estimatedTotalAssets() >= total_debt
#
#     pps_before = vault.pricePerShare()
#     # test profitable harvest from unsold bals from old
#     strategy.harvest(fromGov)
#
#     util.stateOfStrat("new strategy after harvest", strategy, token)
#
#     # pps unlock
#     chain.sleep(3600 * 6)
#     chain.mine(1)
